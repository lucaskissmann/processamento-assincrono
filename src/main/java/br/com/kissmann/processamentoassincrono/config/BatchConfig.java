package br.com.kissmann.processamentoassincrono.config;
...
public class BatchConfig {
  ...
  @Bean
  public Step importarClienteStep(ItemReader<Pessoa> reader, ItemProcessor<Pessoa, Future<Pessoa>> processor, ItemWriter<Future<Pessoa>> writer) {
  ...
  @Bean
  public ItemProcessor<Pessoa, Future<Pessoa>> asyncProcessor(ItemProcessor<Pessoa, Pessoa> itemProcessor, TaskExecutor taskExecutor) {
